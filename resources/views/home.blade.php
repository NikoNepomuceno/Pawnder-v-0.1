                            ...
                            <div class="post-user-info">
                                ...
                                <div>
                                    <h4 class="post-author">{{ $post->sharedBy->name }} <span
                                            style="font-weight:normal; color:#888;"><i class="fas fa-share-alt"
            ...
            @empty
                <div class="no-results-message" style="text-align:center; color:#888; font-size:1.2rem; margin:40px 0;">
                    ...
                    <div style="margin-top:24px; display:flex; justify-content:center;">
                        <img src="/images/no-results-sticker.png" alt="No results sticker"
                            style="max-width:120px; opacity:0.85;">
                    </div>
                </div>
            @endforelse
        </div>
            ...
            <form id="reportPostForm" action="" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea id="reason" name="reason" required
                        placeholder="Please explain why you're reporting this post..."></textarea>
                </div>
            ...
            <form id="createPostForm" action="{{ route('posts.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="file-input-container">
                        <button type="button" class="file-input-button" id="upload_widget"><i class="fas fa-camera"></i> Upload Photos</button>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.grid-item').forEach(item => {
                item.addEventListener('click', function () {
                    ...
                    const postImages = Array.from(document.querySelectorAll(`.grid-item[data-post-id="${postId}"]`))
            ...
            confirmSharePostBtn.addEventListener('click', function () {
                ...
                .catch(() => showAppNotification('Failed to share post. An unexpected error occurred.', 'error'))
                .finally(() => {
                    hideModal(sharePostConfirmModal);
                    postIdToShare = null;
                });
