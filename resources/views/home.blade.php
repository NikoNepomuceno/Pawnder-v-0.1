    ...
    <div class="content">
        ...
        <div class="posts-container">
            @forelse($posts as $post)
                <div class="post-card {{ $post->is_flagged ? 'flagged-post' : '' }}" 
                     data-post-id="{{ $post->id }}"
                     {{ $post->is_taken_down ? 'data-taken-down="' . $post->updated_at . '"' : '' }}>
                    @if($post->is_flagged)
            ...
            @empty
                <div class="no-results-message no-results-message-styling">
                    ...
                    <div class="no-results-image-container">
                        <img src="/images/no-results-sticker.png" 
                             alt="No results sticker" 
                             class="no-results-image-styling">
                    </div>
                </div>
            @endforelse
        </div>
    ...
    <div id="createPostConfirmModal" class="modal">
        <div class="modal-content modal-content-small">
            ...
            <div class="form-actions">
                ...
                <button type="button" 
                        class="submit-btn" 
                        id="confirmCreatePostBtn" 
                        onclick="submitCreatePostForm()">
                    Create Post
                </button>
            </div>
        </div>
