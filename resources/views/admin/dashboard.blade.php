...
@section('content')
            ...
            <div class="lg:p-8 p-4">
                ...
                <div class="flex items-center justify-between mb-8 pt-16 lg:pt-0">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-sm text-gray-500 hidden sm:block">Welcome back, Admin</span>
                    </div>
                </div>
    ...
    <div id="archiveReportConfirmModal"
        class="fixed inset-0 z-50 hidden items-center justify-center bg-black/25 backdrop-blur-sm">
        <div
            class="relative bg-white rounded-2xl p-8 shadow-lg min-w-[320px] max-w-[90vw] text-center flex flex-col items-center border border-gray-200">
            <button class="absolute right-4 top-4 text-2xl text-gray-500 hover:text-gray-700 transition-colors"
                id="closeArchiveModal" tabindex="0" aria-label="Close">&times;</button>
            ...
            <div class="flex justify-center gap-4">
                <button
                    class="px-6 py-2.5 rounded-lg bg-gray-100 text-gray-700 font-semibold hover:bg-gray-200 transition-colors"
                    id="cancelArchive">Cancel</button>
                <button
                    class="px-6 py-2.5 rounded-lg bg-blue-500 text-white font-semibold hover:bg-blue-600 transition-colors"
                    id="confirmArchive">Archive</button>
            </div>
        </div>
    </div>

    <!-- Approve Report Confirmation Modal -->
    <div id="approveReportConfirmModal"
        class="fixed inset-0 z-50 hidden items-center justify-center bg-black/25 backdrop-blur-sm">
        <div
            class="relative bg-white rounded-2xl p-8 shadow-lg min-w-[320px] max-w-[90vw] text-center flex flex-col items-center border border-gray-200">
            <button class="absolute right-4 top-4 text-2xl text-gray-500 hover:text-gray-700 transition-colors"
                id="closeApproveModal" tabindex="0" aria-label="Close">&times;</button>
            ...
            <div class="flex justify-center gap-4">
                ...
                <button
                    class="px-6 py-2.5 rounded-lg bg-green-500 text-white font-semibold hover:bg-green-600 transition-colors"
                    id="confirmApprove">Approve</button>
            </div>
        </div>
    </div>
...
@push('scripts')
    ...
    <style>
        ...
        /* Keep the old animations for backward compatibility */
        @keyframes slideIn {
            from {
